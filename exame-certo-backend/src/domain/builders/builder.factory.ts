...
export abstract class BuilderFactory {
  abstract createPatientBuilder(id?: string, password?: string, encryptedPassword?: string): Promise<PatientBuilder>;
  abstract createDoctorBuilder(id?: string, password?: string, encryptedPassword?: string): Promise<DoctorBuilder>;
  abstract createClinicBuilder(id?: string, password?: string, encryptedPassword?: string): Promise<ClinicBuilder>
