...
export default function DashSidebar() {
    const projectName = process.env.SITE_NAME
    return (
        <>
            ...
            <aside id="sidebar-multi-level-sidebar"
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <a href="#" className="flex items-center ps-2.5 mb-5">
                        ...
                        <span
                            className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{projectName}</span>
                    </a>
                        ...
                        <li>
                            <button type="button"
                                ...
                                <svg
                                    ...
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 18 21">
                                    <path d="M44,16c-0.553,0-1-0.447-1-1V0H7C4.789,0,3,1.789,3,4v56c0,2.211,1.789,4,4,4h48c2.211,0,4-1.789,4-4V16H44
		...
		c0.553,0,1,0.447,1,1S48.553,27,48,27z" />
                                ...
                                <span
                                    className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Exames</span>
